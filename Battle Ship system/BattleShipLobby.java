...
/**
 * class that can let the user host or join any number of games useing the battleship protocols
 * Homework 12.
 *
...
public class BattleShipLobby {
    ...
    static String hostGame( int Port, player HostPlayer ) {
        ...
        try {
            ...
            System.out.println("Your name is " + InetAddress.getLocalHost().getHostAddress());
